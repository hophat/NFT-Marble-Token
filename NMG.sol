 ...
 * is concerned).
 *
 * This contract is only required for intermediate, library-like contracts.a
 */
...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
     ...
     *
     * This is an alternative to {approve} that can be used as a mitigation forwz
...
// File: @openzeppelin/contracts/token/BEP20/extensions/BEP20Burnable.sol
...
// File: contracts/PTK.sol

contract NMG is BEP20, BEP20Burnable, Pausable, Ownable {
    mapping(address => bool) public lockedOf;
    mapping(address => uint256) public lockedOfamount;
     uint public _totalSupply;
    constructor() BEP20("NFT Marble Game", "NMG") {
  ...
  function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(isUnLockedOf(_msgSender(),amount), "This account is locked");
  ...
  function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(isUnLockedOf(sender, amount), "sender is locked");
